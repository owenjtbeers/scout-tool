...
import { Polygon, Marker, Geojson, LatLng, Polyline } from "react-native-maps";
 ...
 */
export const DrawingManager = (props: { mapRef: React.RefObject<MapRef> }) => {
  const { mapRef } = props;
    ...
    <>
      ...
      {tempGeoJSON !== null && (
        <GeojsonLayerGL
          ...
          ID={-99}
          geojson={tempGeoJSON}
          color={colors.selectedFieldBoundaryFill}
        />
      )}
    </>
  );
